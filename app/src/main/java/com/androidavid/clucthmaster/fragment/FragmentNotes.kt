...
import com.androidavid.clucthmaster.adapter.NoteAdapter
import com.androidavid.clucthmaster.databinding.FragmentNotesBinding
import com.androidavid.clucthmaster.model.Note
import com.androidavid.clucthmaster.viewmodel.NoteViewModel


class FragmentNotes : Fragment(R.layout.fragment_notes), SearchView.OnQueryTextListener,MenuProvider {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.addNoteFab.setOnClickListener {
            it.findNavController().navigate(R.id.action_fragmentNotes_to_fragmentAddNote)
        }
    }
